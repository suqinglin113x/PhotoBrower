...
- (void)initDisplayLabel {
    CGRect frame = CGRectMake(SCREEN_WIDTH - 100, 20, 80, 30);
    ...
    self.displayLabel.backgroundColor = [UIColor orangeColor];
    ...
    [[UIApplication sharedApplication].windows[0] addSubview:self.displayLabel];
}
